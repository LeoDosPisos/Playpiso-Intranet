...
> Arquivos-chave: `Frontend/src/route/FormPropostaComercial/config/`, `Backend/PlaypisoIntranet/DTOs/`, `Backend/PlaypisoIntranet/Repositories/ProposalRepository.cs`
