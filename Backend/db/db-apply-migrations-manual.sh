#!/usr/bin/env bash
# Applies DbUp-compatible migrations via psql without starting the application.
# Prefer the API startup migration path in Program.cs for normal use.
# Use this only for exceptional/manual database maintenance.
...
#   PlaypisoIntranet.Migrations.V001__create_proposals.sql
DBUP_NAMESPACE="PlaypisoIntranet.Migrations"
